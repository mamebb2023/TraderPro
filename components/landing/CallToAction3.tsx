  ...
  return (
    <section className="relative py-24 overflow-hidden">
      <div className="absolute inset-0 flex justify-center items-center">
        <div className="w-[90%] max-w-4xl h-[300px] rounded-3xl bg-gradient-to-br from-[#001F3F] to-[#4B8EE7] opacity-40 blur-2xl" />
      </div>
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6">
        <motion.div
          ...
          viewport={{ once: true }}
          className="bg-white/10 backdrop-blur-md rounded-3xl border border-white/20 shadow-xl p-10 text-center text-white"
        >
          <p className="text-sm uppercase tracking-wider mb-2 text-blue-200 font-medium">
            TrackerPro
          </p>
